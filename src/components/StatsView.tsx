                    ...
                    <For each={[...props.matchHistory].reverse()}>
                      {(m, i) => (
                        <tr class="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors">
                          ...
                          <td class="py-2 pr-3 tabular-nums font-bold text-slate-800 dark:text-slate-200">
                            {m.score1} — {m.score2}
                          </td>
                          <td class="py-2 pr-3 tabular-nums text-slate-500 dark:text-slate-400">{m.duration}</td>
                        </tr>
                      )}
                    </For>
                  </tbody>
